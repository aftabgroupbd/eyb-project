...
<head>
    ...
    <link rel="shortcut icon" href="{{asset('/')}}assets/adminassets/images/favicon.ico">
        ...
        <div class="topbar-left">
            <div class="text-center">
                ...
                <a href="index.html" class="logo">
                    <img src="{{asset('/')}}assets/adminassets/images/logo-lg.png" alt="" class="logo-large">
                </a>
            </div>
        </div>
        ...
        <div class="sidebar-inner niceScrollleft">
            ...
            <div id="sidebar-menu">
                <ul>
                    ...
                    <li>
                        <a href="{{route('manage_question')}}" class="waves-effect">
